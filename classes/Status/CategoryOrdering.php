...
/**
 * Category display order for the public page (ISSUE-205.4): `order`
 * ascending, then `title` for stable ties. Same rule
 * `CategoryOptions::formatOptions()` (ISSUE-205.2) applies to the admin
 * form's dynamic option list, factored out here so the two call sites share
 * one tested implementation instead of two copies that can drift apart.
 */
