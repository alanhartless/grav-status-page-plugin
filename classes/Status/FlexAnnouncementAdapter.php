 ...
 * piece of EPIC-205's status-projection logic that touches Flex objects at
 * all -- kept deliberately thin so the actual interval-overlap/day-boundary
 * logic in StatusProjector stays completely framework-free and gets the
 * exhaustive coverage there instead (ISSUE-205.3 AC).
 *
