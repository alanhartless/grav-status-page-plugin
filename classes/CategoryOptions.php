 ...
 * so it is exercised by the Admin2/Flex-API round-trip recorded in
 * ISSUE-205.2, not by PHPUnit. `formatOptions()` and `resolveTitles()` are
 * pure functions with no Grav dependency and carry the actual test coverage.
 *
