 ...
 * (ISSUE-205.2) applies to the admin form's option list -- factored out here
 * as its own pure, tested function rather than re-deriving the sort inline
 * in the rendering glue.
 */
