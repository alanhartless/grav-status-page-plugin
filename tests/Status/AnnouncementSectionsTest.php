...
/**
 * The public page's announcement sections: active/watching at the top,
 * resolved-within-the-window at the bottom, newest first. Pure
...
final class AnnouncementSectionsTest extends TestCase
{
    ...
    // YAML on disk, so a single unparseable started_at/ended_at must not
    // crash either section for every other announcement. --
