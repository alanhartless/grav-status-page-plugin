...
/**
 * The banner's overall level (ISSUE-205.4 AC: "an overall banner stating
 * whether all categories are currently operational") is the worst of every
 * category's own `current` level -- same severity order StatusProjector uses
 * (outage > partial-outage > operational).
 */
