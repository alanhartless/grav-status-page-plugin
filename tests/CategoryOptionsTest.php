 ...
 *    resolves (EPIC-205 ISSUE-205.2 AC: deleting a referenced category must
 *    not fatal rendering -- the dangling key is ignored, not an error).
 *
 * Only the pure helpers are covered here; `options()` itself requires a
 * live $grav['flex'] and is exercised by the Admin2/CLI round-trip recorded
 * in the issue file instead.
 */
